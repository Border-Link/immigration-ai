"""
Status Transition Validator for Reviews
...
VALID_TRANSITIONS = {
    ...
    'in_progress': ['completed', 'cancelled', 'pending'],  # Can be reassigned back to pending
    'completed': [],  # Terminal state
    'cancelled': ['pending'],  # Can be reopened
}


class ReviewStatusTransitionValidator:
    """Validator for review status transitions."""
